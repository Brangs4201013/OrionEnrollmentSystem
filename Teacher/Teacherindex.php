              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addUserModal">Add a new Teacher</button>
                  </div>
                  <div class="card-body">
                      ...
                      >
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<a href='TeacherController.php?user_id=".$row["User_ID"]."' type='button' class='btn btn-link btn-danger delete-btn'>";
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="TeacherController.php" method="POST">
                    <div class="row ">
                        <div class="col-md-6">
                    ...
                    <div class="card-action ms-auto me-auto" style="text-align: center;">
                        <button type="submit" class="btn btn-success" name="saveTeacher">Submit</button>
...
<div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUserModalLabel">Edit Teacher</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="TeacherController.php" method="POST">
                    ...
                    <div class="card-action ms-auto me-auto" style="text-align: center;">
                        <button type="submit" class="btn btn-success" name="editTeacher">Submit</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                    </div>
                </form>
            </div>
...
<script>
    ...
    if (message === 'created') {
        swal({
            title: "Success!",
            text: "New teacher record created successfully!",
            icon: "success"
        }).then(() => {
            window.location.href = "Teacherindex.php"; // Removes message from URL
        });
    } else if (message === 'error') {
        swal({
            title: "Error!",
            text: "Failed to create teacher record.",
            icon: "error"
        }).then(() => {
    ...
    if (message === 'deleted') {
        ...
        swal({
            title: "Error!",
            text: "Failed to delete teacher record.",
            icon: "error"
        }).then(() => {
            window.location.href = "Teacherindex.php";
        });
    ...
    if (message === 'updated') {
        ...
        swal({
            title: "Error!",
            text: "Failed to update teacher record.",
            icon: "error"
        }).then(() => {
            window.location.href = "Teacherindex.php";
        });
